...
geoquery_dir=os.path.join(data_dir,'geoquery')
free917_dir=os.path.join(data_dir,'free917')
res_dir=os.path.join(home,'res')
res_prolog=os.path.join(res_dir,'prolog')
mdl_dir=os.path.join(home,'mdl')
mdl_prolog=os.path.join(mdl_dir,'prolog')
lib_dir=os.path.join(home,'lib')
embs=os.path.join(data_dir,'embs')
emb=os.path.join(embs,'glove.6B.100d.txt')

opt_parser=OptionParser()
opt_parser.add_option('--data',dest='data',metavar='FILE',default=geoquery_dir)
opt_parser.add_option('--result',dest='result',metavar='FILE',default=res_prolog)
opt_parser.add_option('--model',dest='model',metavar='FILE',default=mdl_prolog)
...
opt_parser.add_option('--dim_nt',dest='dim_nt',type='int',default=50)
opt_parser.add_option('--dim_ter',dest='dim_ter',type='int',default=50)
...
# opt_parser.add_option('--epochs',dest='epochs',type='int',default=30)
opt_parser.add_option('--epochs',dest='epochs',type='int',default=100)
